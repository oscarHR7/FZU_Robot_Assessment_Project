...
//修改部分
#define TCS_SDA_IN()  {GPIOB->CRL&=0xF0FFFFFF;GPIOB->CRL|=8<<24;}
#define TCS_SDA_OUT() {GPIOB->CRL&=0xF0FFFFFF;GPIOB->CRL|=3<<24;}
#define TCS_SDA_READ   GPIOB->IDR&(1<<6)

#define TCS_SCL_H     GPIO_SetBits(GPIOB,GPIO_Pin_7)
#define TCS_SCL_L     GPIO_ResetBits(GPIOB,GPIO_Pin_7)
#define TCS_SDA_H     GPIO_SetBits(GPIOB,GPIO_Pin_6)
#define TCS_SDA_L     GPIO_ResetBits(GPIOB,GPIO_Pin_6)
//extern void delay_s(u32 i);
...
void TCS34725_I2C_Init()
{
	...
	//修改部分
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6|GPIO_Pin_7;//PB10/PB10=外接I2C
